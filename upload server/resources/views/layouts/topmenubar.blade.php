...
<!-- header-end -->
<div class="sidenav">
    <a href="#" onclick="return false;"><i class="fab fa-whatsapp"></i></i></a>
    <a href="#" onclick="return false;"><i class="fa fa-calendar"></i></a>
    <a href="#" onclick="return false;"><i class="fa fa-envelope"></i></a>
    <a href="#" onclick="return false;"><i class="fa fa-headset"></i></a>
</div>
