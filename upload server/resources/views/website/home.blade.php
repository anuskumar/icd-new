            ...
            <div class="container mar-bot">
                ...
                <div class="team-active mar-bot class-scroll">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/RUSSIA.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">
                            {{-- <img src="{{ asset('assets/img/bg/rec1.jpg') }}" alt="contact-bg-an-01"> --}}
                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(181),'name' =>'universities-in-russia' ]) }}" >Russia</a></h4>
                            <p class="overflow-auto" style="height:120px">With world-class teaching and top infrastructure, Russia has become a major hub for MBBS
                                education, hosting over 10,000 international students.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Russia_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                            </div>
                        </div>
                        <!-- class-img -->
                    </div>
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/UKRAINE.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(228),'name' =>'universities-in-Ukraine' ]) }}" >Ukraine</a></h4>
                            <p class="overflow-auto" style="height:120px">An MBBS student studying in Ukraine may work in any country in Europe without taking extra
                                tests.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Ukraine_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/azerbaijan.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(15),'name' =>'universities-in-Azerbaijan' ]) }}">Azerbaijan</a></h4>
                            <p class="overflow-auto" style="height:120px">Emerging destination known for affordable MBBS and modern clinical exposure.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Azerbaijan_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/icon/canada.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(38),'name' =>'universities-in-Canada' ]) }}">Canada</a></h4>
                            <p class="overflow-auto" style="height:120px">High academic standards and a pathway to medical residency programs globally.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Canada_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/united-states-of-america.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(231),'name' =>'universities-in-United-State-of-America' ]) }}">United State of America</a></h4>
                            <p class="overflow-auto" style="height:120px">Home to world-leading medical universities and extensive research opportunities.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/USA_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/AUSTRALIA.jpg') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(13),'name' =>'universities-in-Australia' ]) }}">Australia</a></h4>
                            <p class="overflow-auto" style="height:120px">Offers innovative, globally respected medical programs and vibrant campus life.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Australia_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/NEW_ZEALAND.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(157),'name' =>'universities-in-New-Zealand' ]) }}" >New Zealand</a></h4>
                            <p class="overflow-auto" style="height:120px">New Zealand offers focused medical education, full-time work rights for spouses, and a
                                one-year post-study work visa for graduates.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/NewZealand_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/NEPAL.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(153),'name' =>'universities-in-Nepal' ]) }}">Nepal</a></h4>
                            <p class="overflow-auto" style="height:120px">Indian-curriculum-friendly MBBS programs with cultural familiarity and easy adaptability.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Nepal_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/INDIA.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(101),'name' =>'universities-in-India' ]) }}">India</a></h4>
                            <p class="overflow-auto" style="height:120px">In India, students must appear for the NEET exam to pursue MBBS, >50 percentile is required
                                for eligibility, although the merit cut-offs can vary each year.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/India_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/vietnam.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(238),'name' =>'universities-in-Vietnam' ]) }}">Vietnam</a></h4>
                            <p class="overflow-auto" style="height:120px">Vietnam is gaining popularity for affordable medical education, improving healthcare
                                infrastructure, culturally welcoming.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Vietnam_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/philippines.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(173),'name' =>'universities-in-Philippines' ]) }}" >Philippines</a></h4>
                            <p class="overflow-auto" style="height:120px">The Philippines is preferred for its English-speaking environment, US-based medical training
                                model, and climate similar to India.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/bg/rec1.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/malaysia.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(132),'name' =>'universities-in-Malaysia' ]) }}">Malaysia</a></h4>
                            <p class="overflow-auto" style="height:120px">Well-regarded for offering high-quality MBBS courses with multicultural exposure.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/egypt.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(64),'name' =>'universities-in-Egypt' ]) }}" >Egypt</a></h4>
                            <p class="overflow-auto" style="height:120px">Ancient land offering modern medical programs with strong historical roots in healthcare
                                sciences.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/UNITED_KINGDOM.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(230),'name' =>'universities-in-United-Kingdom' ]) }}">United Kingdom</a></h4>
                            <p class="overflow-auto" style="height:120px">Renowned for its prestigious universities and rich academic heritage, the UK offers diverse
                                programs and a multicultural environment, enhancing global career prospects.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/germany-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(82),'name' =>'universities-in-Germany' ]) }}">Germany</a></h4>
                            <p class="overflow-auto" style="height:120px">Known for its strong engineering and technical programs, Germany provides tuition-free
                                education in public universities and a vibrant student life amidst historical cities.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/france-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(75),'name' =>'universities-in-France' ]) }}" >France</a></h4>
                            <p class="overflow-auto" style="height:120px">Combining world-class education with a rich cultural experience, France offers programs in
                                various fields, complemented by its art, cuisine, and history.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/italy-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(107),'name' =>'universities-in-Italy' ]) }}">Italy</a></h4>
                            <p class="overflow-auto" style="height:120px">Italy's universities are celebrated for arts, architecture, and design programs, set against
                                a backdrop of historical landmarks and Mediterranean lifestyle.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                ...
                <div class="team-active  class-scroll">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/spain.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">
                            {{-- <img src="{{ asset('assets/img/bg/rec1.jpg') }}" alt="contact-bg-an-01"> --}}
                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(205),'name' =>'universities-in-Spain' ]) }}">Spain</a></h4>
                            <p class="overflow-auto" style="height:120px">Offering a blend of quality education and lively culture, Spain attracts students with its
                                affordable living costs and diverse academic offerings.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Spain_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                            </div>
                        </div>
                        <!-- class-img -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/poland-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(175),'name' =>'universities-in-Poland' ]) }}" >Poland</a></h4>
                            <p class="overflow-auto" style="height:120px">Emerging as a hub for international students, Poland provides affordable education in
                                English-taught programs, especially in medicine and engineering.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Poland_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/ROMANIA.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(180),'name' =>'universities-in-Romania' ]) }}" >Romania</a></h4>
                            <p class="overflow-auto" style="height:120px">Romania offers cost-effective medical and technical education, with degrees recognized across
                                Europe and a welcoming environment for international students.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Romania_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/belgium-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(21),'name' =>'universities-in-Belgium' ]) }}">Belgium</a></h4>
                            <p class="overflow-auto" style="height:120px">Home to EU institutions, Belgium provides multilingual education opportunities and a rich
                                cultural tapestry, ideal for international relations and political science studies.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Belgium_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/SWEDEN.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(221),'name' =>'universities-in-Sweden' ]) }}" >Sweden</a></h4>
                            <p class="overflow-auto" style="height:120px">Known for innovation and sustainability, Sweden's universities emphasize research and
                                critical thinking, attracting students interested in progressive education.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Sweden_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/hungary-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(228),'name' =>'universities-in-Hungry' ]) }}">Hungry</a></h4>
                            <p class="overflow-auto" style="height:120px">With a growing reputation in medical and dental studies, Hungary offers high-quality
                                education at competitive costs in historic cities like Budapest.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Hungary_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/BOZNIA.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(27),'name' =>'universities-in-Bosnia-and-Herzegovina' ]) }}">Bosnia and Herzegovina</a></h4>
                            <p class="overflow-auto" style="height:120px">Offering affordable education in a multicultural setting, Bosnia and Herzegovina is gaining
                                attention for programs in humanities and social sciences.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/BosniaHerzegovina_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/Moldova.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(144),'name' =>'universities-in-Moldova' ]) }}" >Moldova</a></h4>
                            <p class="overflow-auto" style="height:120px">Moldova provides budget-friendly education options, particularly in medical fields, within a
                                culturally rich Eastern European context.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Moldova_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/latvia.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(120),'name' =>'universities-in-Latvia' ]) }}">Latvia</a></h4>
                            <p class="overflow-auto" style="height:120px">Latvia's universities offer programs in IT and business, with a focus on innovation and a
                                growing international student community.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Latvia_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/lithuania-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(126),'name' =>'universities-in-Lithuania' ]) }}" >Lithuania</a></h4>
                            <p class="overflow-auto" style="height:120px">Latvia's universities offer programs in IT and business, with a focus on innovation and a
                                growing international student community.</p>
                        </div>
                        <!-- class-content-end -->
                        ...
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Lithuania_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/malta.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(135),'name' =>'universities-in-Malta' ]) }}" >Malta</a></h4>
                            <p class="overflow-auto" style="height:120px">As an English-speaking country, Malta offers programs in various disciplines, coupled with a
                                Mediterranean lifestyle and historical sites.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/GEORGIA-1.jpg') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(81),'name' =>'universities-in-Georgia' ]) }}" >Georgia</a></h4>
                            <p class="overflow-auto" style="height:120px">Georgia is becoming a favored destination for medical studies, offering affordable tuition
                                and programs taught in English.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/ARMENIA.jpg') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(11),'name' =>'universities-in-Armenia' ]) }}">Armenia</a></h4>
                            <p class="overflow-auto" style="height:120px">Armenia offers quality education in medicine and technology, with a rich cultural heritage
                                and hospitable environment.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/BELARUS.jpg') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(20),'name' =>'universities-in-Belarus' ]) }}" >Belarus</a></h4>
                            <p class="overflow-auto" style="height:120px">Known for its strong science and engineering programs, Belarus provides affordable education
                                with a focus on practical skills.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/BULGARIA.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(33),'name' =>'universities-in-Bulgaria' ]) }}" >Bulgaria</a></h4>
                            <p class="overflow-auto" style="height:120px">Bulgaria offers medical and technical programs recognized across Europe, with competitive
                                tuition fees and diverse cultural experiences.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/IRELAND.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(105),'name' =>'universities-in-Ireland' ]) }}">Ireland</a></h4>
                            <p class="overflow-auto" style="height:120px">Ireland's universities are esteemed for research and innovation, offering a friendly
                                atmosphere and strong links to global industries.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/FINLAND.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(74),'name' =>'universities-in-Finland' ]) }}">Finland</a></h4>
                            <p class="overflow-auto" style="height:120px">Finland emphasizes student-centered learning and innovation, with a high quality of life and
                                programs in various fields.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
        ...
        <section class="class-area c-padding p-relative fix" style="background-color:#F1F1F1;">
            <div class="container mar-bot">
                ...
                <div class="team-active class-scroll">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/NETHERLANDS.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">
                            {{-- <img src="{{ asset('assets/img/bg/rec1.jpg') }}" alt="contact-bg-an-01"> --}}
                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(155),'name' =>'universities-in-Netherland' ]) }}" >Netherland</a></h4>
                            <p class="overflow-auto" style="height:100px">The Netherlands offers a wide range of English-taught programs, known for their interactive
                                teaching methods and international outlook.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Netherlands_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                            </div>
                        </div>
                        <!-- class-img -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/czech-republic.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(57),'name' =>'universities-in-Czech-Republic' ]) }}" >Czech Republic</a></h4>
                            <p class="overflow-auto" style="height:100px">With a long-standing academic tradition, the Czech Republic provides affordable education in
                                medicine, engineering, and humanities.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/czech_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/Greece.webp') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(85),'name' =>'universities-in-Greece' ]) }}" >Greece</a></h4>
                            <p class="overflow-auto" style="height:120px">Greece combines quality education in fields like archaeology and philosophy with a rich
                                historical and cultural setting.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Greece_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/austria-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(14),'name' =>'universities-in-Austria' ]) }}" >Austria</a></h4>
                            <p class="overflow-auto" style="height:120px">Austria offers high-quality education, particularly in arts and music, set amidst picturesque
                                landscapes and historic cities.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Austria_ICD.jpg') }}"
                                        class="countriesborder" alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <!-- class-item -->
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/SERBIA.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(193),'name' =>'universities-in-Serbia' ]) }}" >Serbia</a></h4>
                            <p class="overflow-auto" style="height:120px">Serbia is gaining recognition for its medical and engineering programs, offering affordable
                                tuition and a vibrant cultural scene.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Serbia_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/denmark.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(58),'name' =>'universities-in-Denmark' ]) }}">Denmark</a></h4>
                            <p class="overflow-auto" style="height:120px">Denmark's education system emphasizes creativity and innovation, with programs in
                                sustainability and design attracting global students.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Denmark_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/Norway.webp') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(164),'name' =>'universities-in-Norway' ]) }}" >Norway</a></h4>
                            <p class="overflow-auto" style="height:120px">Norway offers tuition-free education in public universities, with strong programs in
                                environmental sciences and engineering.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Norway_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/slovakia.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(197),'name' =>'universities-in-Slovakia' ]) }}" >Slovakia</a></h4>
                            <p class="overflow-auto" style="height:120px">Slovakia provides cost-effective education in medicine and technology, with degrees
                                recognized across the EU.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Slovakia_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/croatia.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(54),'name' =>'universities-in-Croatia' ]) }}" >Croatia</a></h4>
                            <p class="overflow-auto" style="height:120px">Croatia offers programs in tourism, hospitality, and marine sciences, set along its stunning
                                Adriatic coastline.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Croatia_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/albania.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(2),'name' =>'universities-in-Albania' ]) }}">Albania </a></h4>
                            <p class="overflow-auto" style="height:120px">Albania is emerging as a destination for affordable education in business and social
                                sciences, with a warm Mediterranean climate.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                            <div class="countries">
                                <a href="single-courses-2.html" onclick="return false;"> <img src="{{ asset('assets/img/Countries_Images/Albania_ICD.jpg') }}"
                                        class="countriesborder"alt="contact-bg-an-01"></a>
                                <!-- course-meta -->
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/ICELAND.png') }}" class="countriesicon"
                                    alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(100),'name' =>'universities-in-Iceland' ]) }}" >Iceland </a></h4>
                            <p class="overflow-auto" style="height:120px">Known for its unique geology and environmental studies, Iceland offers specialized programs
                                amidst breathtaking natural landscapes.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/slovenia.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(198),'name' =>'universities-in-Slovenia' ]) }}" >Slovenia </a></h4>
                            <p class="overflow-auto" style="height:120px">Slovenia combines quality education in technology and environmental sciences with a high
                                standard of living and natural beauty.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/NORTH_MACEDONIA.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(129),'name' =>'universities-in-North-Macedonia' ]) }}">North Macedonia </a></h4>
                            <p class="overflow-auto" style="height:120px">North Macedonia offers affordable education in various fields, with a growing number of
                                programs taught in English.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/estonia-512.webp') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(68),'name' =>'universities-in-Estonia' ]) }}" >Estonia</a></h4>
                            <p class="overflow-auto" style="height:120px">NorthEstonia is a leader in digital innovation, offering programs in IT and e-governance,
                                attracting tech-savvy students worldwide.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/LUXEMBOURG.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(127),'name' =>'universities-in-Luxembourg' ]) }}" >Luxembourg</a></h4>
                            <p class="overflow-auto" style="height:120px">Luxembourg provides multilingual education opportunities, particularly in finance and
                                European law, within a dynamic economic hub.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/KAZAKHSTAN.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges',['countryId' =>  base64_encode(112),'name' =>'universities-in-Kazakhstan' ]) }}">Kazakhstan</a></h4>
                            <p class="overflow-auto" style="height:120px">Kazakhstan offers modern campuses and programs in engineering and natural sciences, with a
                                focus on research and innovation.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/uzbekistan.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(234),'name' =>'universities-in-Uzbekistan' ]) }}" >Uzbekistan</a></h4>
                            <p class="overflow-auto" style="height:120px">Uzbekistan is investing in higher education reforms, providing opportunities in fields like
                                agriculture, medicine, and IT.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/TAJIKISTAN.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(215),'name' =>'universities-in-Tajikistan' ]) }}" >Tajikistan</a></h4>
                            <p class="overflow-auto" style="height:120px">Tajikistan offers affordable education in medicine and engineering, with a growing emphasis
                                on international collaboration. </p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
                    ...
                    <div class="class-item mb-30" style="height:550px;">
                        <div><span><img src="{{ asset('assets/img/countires_flag/KYRGYSTAN.png') }}"
                                    class="countriesicon" alt="img">
                            </span></div>
                        <!-- class-content -->
                        <div class="class-content">

                            <h4 class="title"><a href="{{ route('listing.colleges', ['countryId' =>  base64_encode(118),'name' =>'universities-in-Kyrgyzstan' ]) }}" >Kyrgyzstan</a></h4>
                            <p class="overflow-auto" style="height:120px">Kyrgyzstan is known for its medical universities offering English-taught programs, attracting
                                students from various countries.</p>
                        </div>
                        <!-- class-content-end -->
                        <!-- class-img -->
                        <div class="class-img">
